...
3. **Latent Space Planning**
    ...
    - **Model-based planning**
        ...
        - **Model Predictive control**의 형태로 학습이 진행되는데, ****각 step마다 planning을 하고 action을 실행한 뒤 replanning을 하는 형태로 이루어 집니다. 즉, 기존 RL처럼 policy나 value network를 사용하지 않는 hybrid형태의 학습 방법 입니다.
