---
layout: post
title:  "Neural Networks and Deep Learning assignment-02"
subtitle:   ""
categories: deeplearning
tags: lecture
---

loss 는 줄어드는데, acc이 안나온다. 코드상에 문제는 안보이는 것 같은데

나는 사진이 계속 내가보기에도 깨져나오는데 깃허브에서 파일을 잘못받은건지.. ㅠㅠ
...
def propagate(w, b, X, Y):
    ...
    ### START CODE HERE ### (≈ 2 lines of code)
    A = sigmoid(np.sum(w * X,axis=0) + b)                                   # compute activation
...
def predict(w, b, X):
    ...
    ### START CODE HERE ### (≈ 1 line of code)
    A = sigmoid(np.sum(w * X,axis=0) + b).reshape(-1,1)
    ### END CODE HERE ###
